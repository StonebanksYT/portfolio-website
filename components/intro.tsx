...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] mt-32 text-center sm:mb-0 scroll-mt-[100rem]"
    >
      <motion.h1
      ...
      >
        <span>
          Hello, I'm <b>Kaustubh</b>.
        </span>{" "}
        I'm an aspiring <b>software developer</b> specializing in{" "}
        <span className="font-bold">Web Development</span>. I am passionate
        about building
        <span className="italic"> innovative solutions</span> with expertise in{" "}
        <span>MERN, Next.js, Python, and Cloud technologies</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/kaustubh-tiwari-60a623138"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/StonebanksYT"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
